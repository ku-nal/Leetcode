<h2>1537. Get the Maximum Score</h2><h3>Hard</h3><hr><div><p>You are given two <strong>sorted</strong> arrays of distinct integers <code>nums1</code> and <code>nums2.</code></p>
